...
public class BoringPokemonResource {
	...
	// accessible from http://localhost:8080/PokeAPI/rest/boring-pokemon
	public Response getAllBoringPokemon(@Context HttpServletRequest request) {
	...
	@Produces(MediaType.APPLICATION_JSON)
	// http://localhost:8080/PokeAPI/rest/boring-pokemon/SomePokemonName
	...
	public Response digestFormData(@FormParam("pokemonName") String name, @FormParam("pokemonType") String type) {
		System.out.println("Value for pokemon name: " + name);
		System.out.println("Value for pokemon type: " + type);
