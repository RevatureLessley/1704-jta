...
public class MercuryHomePageGlue { 
	...
	public void a_user_opens_a_web_browser_of_type() throws Throwable {
		driver = DriverFactory.getDriver("chrome");
	}

	@Given("^navigates to Mercury Tours website$")
	public void navigates_to_Mercury_Tours_website() throws Throwable {
	...
	@Given("^the passengers leave on \"([^\"]*)\" (\\d+)$")
	public void the_passengers_leave_on(String arg1, int arg2) throws Throwable {
		flight.flightFinderDropdown(arg1, "fromMonth");
		flight.flightFinderDropdown(String.valueOf(arg2), "fromDay");
	}

	@Given("^the passengers arrive at \"([^\"]*)\"$")
	public void the_passengers_arrive_at(String arg1) throws Throwable {
